...
@router.post("/users/", response_model=UserRead, status_code=HTTPStatus.CREATED)
...
@router.post("/profiles/", response_model=ProfileRead, status_code=HTTPStatus.CREATED)
